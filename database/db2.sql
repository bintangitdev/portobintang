...
INSERT INTO `portofolios` (`id`, `nama`, `gambar`, `link`, `deskripsi`, `status`, `urutan`, `created_at`, `updated_at`) VALUES
	(3, 'Identification of Plant Disease', '2.jpg', 'skp', 'Deploy trained models of machine learning training using flask and ajax.\r\nUse tools ; Python, Javascript, Flask, Tensorflow,Html and Keras', 1, 1, '2022-10-06 15:18:06', '2022-10-13 16:41:07'),
	(4, 'Identification of Tea Leaf Disease', '1.png', 'dsada', 'Website to identification of Apple Plant Diseases using Resnet 50 Dilated.', 1, 1, '2022-10-06 15:20:24', '2022-10-13 16:40:04'),
	(5, 'Testing Applikasi Pegadaian', 'porto1.png', 'zz', 'Manual Test use tools (Postman, DB postgresql); Testing, re-testing, and coordinating with Software Engineers and Bussines Analyst; Automate Testing using Katalon; Create test cases & test suites; Create Test Case use BDD/Cucumber; Data-Driven Test using katalon; Automation API in Katalon; Connect DB in katalon; Create an Automation Test case with a combination use API (GET, POST, PUT, DELETE) and Get Query(SELECT, INSERT, UPDATE and DELETE); Jira; Ocp Mikroservice', 1, 3, '2022-10-13 16:46:30', '2022-10-13 16:47:01'),
	(6, 'Web Dinas Pariwisata dan Kebudayaan Jawa Barat', 'porto4_-_Copy.png', 'zz', 'Black box testing Admin and Moblie Smiling West Java, Automation Test Ad min Smiling West Java using Selenium Python and Java and Collaborate with developer and product owner to stay current on product features and intended functionality.', 1, 4, '2022-10-13 16:48:22', '2022-10-13 16:48:22');
